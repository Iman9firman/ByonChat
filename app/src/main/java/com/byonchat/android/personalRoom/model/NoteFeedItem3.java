...
public class NoteFeedItem3 {
    ...
    public NoteFeedItem3() {
    }

    public NoteFeedItem3(int level, String userid, String id, String id_comment, String name, String image, String status,
