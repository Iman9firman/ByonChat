...
public class VideoFragment extends Fragment {
    public static final String KEY_BUNDLE_FILENAME = "com.byonchat.android.list.VideoFragment.FILENAME";
    public static final String KEY_BUNDLE_START_VIDEO = "com.byonchat.android.list.VideoFragment.START_VIDEO";
    boolean startVideo;
