package com.byonchat.android.personalRoom.transformer;
/**
...
public class RoundedTransformationBuilder implements Transformation<Bitmap> {
    ...
    public enum CornerType {
        ...
        DIAGONAL_FROM_TOP_LEFT, Gravity, DIAGONAL_FROM_TOP_RIGHT
    }
    ...
    public RoundedTransformationBuilder(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundedTransformationBuilder(BitmapPool pool, int radius, int margin) {
