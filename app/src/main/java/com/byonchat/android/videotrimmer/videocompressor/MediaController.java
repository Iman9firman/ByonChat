package com.byonchat.android.videotrimmer.videocompressor;
...
//    }
    ...
    @TargetApi(16)
    public boolean convertVideo(final String path, String outPath, final int startpos, final int endpos, final int fileSizeInMB) {
        ...
        long startTime = startpos * 1000;
        long endTime = endpos * 1000;
