 ...
 */
public class NoteCommentListAdapter extends RecyclerView.Adapter<feedItemsHolder> {
    ...
    public NoteCommentListAdapter(Context context, List<CommentModel> feedItems) {
