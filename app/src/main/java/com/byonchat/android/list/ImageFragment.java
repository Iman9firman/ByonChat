...
public class ImageFragment extends Fragment implements TouchImageView.OnTouchListeners {
    public static final String KEY_BUNDLE_FILENAME = "com.byonchat.android.list.ImageFragment.FILENAME";
    public static final String KEY_BUNDLE_FILECAPTION = "com.byonchat.android.list.ImageFragment.FILECAPTION";
