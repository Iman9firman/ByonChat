...
public class CurvedContainer extends RelativeLayout {
    ...
    private String TAG = "CURVED_CONTAINER";

    public CurvedContainer(Context context) {
        super(context);
        init(context, null);
    }

    public CurvedContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
