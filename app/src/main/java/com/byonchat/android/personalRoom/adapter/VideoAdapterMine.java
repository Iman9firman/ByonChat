 ...
 */
public class VideoAdapterMine extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<PictureModel> data = new ArrayList<>();
    private static int VIEW_ITEM = 1;
    private static int VIEW_BUTTON = 0;
    private static MyClickListenerLongClick myClickListenerLongClick;

    public VideoAdapterMine(Context context, List<PictureModel> data) {
        ...
        if (holder instanceof MyItemHolder) {
            ...
            if(item.getDrawable() == 0){
                ...
                Picasso.with(context)
                        .load(item.getUrl_thumb())
                        .noFade()
                        .placeholder(R.drawable.bt_no_video)
            ...
            Picasso.with(context)
                    .load(R.drawable.bt_add_movie)
                    .noFade()
                    .placeholder(R.drawable.bt_add_movie)
