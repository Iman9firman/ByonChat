...
public class EditText extends android.widget.EditText implements RippleView, TouchMarginView, AnimatedView, TintedView {
    ...
    private void validate() {
        ...
        labelPaint.setColor(context.getResources().getColor(android.R.color.black)/*drawError | counterError ? errorColor : tint.getColorForState(new int[]{android.R.attr.state_focused}, disabledColor)*/);
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (drawDivider) {
            if (isEnabled()) {
                paint.setColor(context.getResources().getColor(android.R.color.black)/*drawError || counterError ? errorColor : tint.getColorForState(getDrawableState(), tint.getDefaultColor())*/);
