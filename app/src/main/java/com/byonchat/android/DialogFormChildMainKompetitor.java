 ...
 */
public class DialogFormChildMainKompetitor extends DialogFragment {
    ...
    public static DialogFormChildMainKompetitor newInstance(String content, String title, String dbMaster, String idDetail, String username, String idTab, String idListTaskMaster, String idChildDetail, String customersId) {
        DialogFormChildMainKompetitor f = new DialogFormChildMainKompetitor();
