...
public class ChatsListFragment extends ListFragment {
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		int indexName = cursor.getColumnIndex(com.byonchat.android.provider.Contact.NAME);
		...
		while (cursor.moveToNext()) {
			...
			if (vo.isGroupChat()) {
				...
				if (name != null) {
					cparty = new com.byonchat.android.provider.Contact(name, jabberId, "");
				} else {
			...
			if (cparty instanceof com.byonchat.android.provider.Contact) {
