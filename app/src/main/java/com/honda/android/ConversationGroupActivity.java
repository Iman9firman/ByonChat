...
import com.honda.android.adapter.GroupNoteAdapter;
import com.honda.android.adapter.ListViewNoteAdapter;
...
import com.honda.android.createMeme.ObjectItem;
...
import com.honda.android.list.ItemCreateNoteGroup;
import com.honda.android.list.utilLoadImage.FileCache;
...
import com.honda.android.utils.DynamicAlertDialogVoting;
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.startsWith("error") || result == null) {
                ...
                if (result.equalsIgnoreCase("1")) {
                    client.disconnect();
                    com.honda.android.provider.Group g = messengerHelper.getGroup(groupId);
