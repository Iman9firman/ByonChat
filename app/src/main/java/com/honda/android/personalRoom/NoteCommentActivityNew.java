...
import com.honda.android.personalRoom.adapter.NoteCommentListAdapter;
import com.honda.android.personalRoom.adapter.NoteCommentListAdapterNew;
 ...
 */
public class NoteCommentActivityNew extends AppCompatActivity implements EmojiconGridFragment.OnEmojiconClickedListener, EmojiconsFragment.OnEmojiconBackspaceClickedListener {

    private static final String TAG = NoteCommentActivityNew.class.getSimpleName();
    RecyclerView mRecyclerView;
    private List<CommentModel> feedItems;
    private NoteCommentListAdapterNew adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(NoteCommentActivityNew.this));
        feedItems = new ArrayList<CommentModel>();
        adapter = new NoteCommentListAdapterNew(NoteCommentActivityNew.this, feedItems);
        ...
        class ambilGambar extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                if (progressDialog == null) {
                    progressDialog = UtilsPD.createProgressDialog(NoteCommentActivityNew.this);
                    progressDialog.show();
                }
                super.onPreExecute();
            }
            ...
            protected void onPostExecute(String s) {
                ...
                if (!s.equals("1")) {
                    Toast.makeText(NoteCommentActivityNew.this, "Check your internet problem.", Toast.LENGTH_LONG).show();
                }
    ...
    private void getListNotesCommentSubmit(String userid, String id_note, final String bc_user, final String idRoomTab) {
        class ambilGambar extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                if (s.equals(null)) {
                    Toast.makeText(NoteCommentActivityNew.this, "Internet Problem.", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        feedItems.clear();
    ...
    private void sendCommentTreePersonal(final String userid, String textComment, final String id_note, final String id_comment, final String bc_user) {
        class ambilGambar extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                progressDialog.dismiss();
                if (!s.equals("1")) {
                    Toast.makeText(NoteCommentActivityNew.this, "Check your internet connection", Toast.LENGTH_LONG).show();
                } else {
                    getListNotesCommentinCommentPersonal(userid, id_note, id_comment, bc_user);
                }
                super.onPostExecute(s);
    ...
    private void sendCommentTestPersonal(final String userid, String textComment, final String id_note, final String bc_user) {
        class ambilGambar extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                progressDialog.dismiss();
                if (!s.equals("1")) {
                    Toast.makeText(NoteCommentActivityNew.this, "Check your internet connection", Toast.LENGTH_SHORT).show();
                } else {
