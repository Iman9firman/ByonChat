...
public class ImageLoadingUtils {
    ...
    public ImageLoadingUtils(Context context){
        ...
        icon = BitmapFactory.decodeResource(context.getResources(), R.color.full_transparent);
    }
    ...
    public Bitmap decodeBitmapFromPath(String filePath){
        ...
        options.inSampleSize = calculateInSampleSize(options, convertDipToPixels(1080), convertDipToPixels(720));
