...
public class JsonUtil2 {
    ...
    public static List<Map<String, Object>> getListFromJsonObject(JSONObject jObject) throws JSONException {
        ...
        for (String key : keysList) {
            ...
            hashMap.put(key, convertJsonItem(jObject.get(key)));
